...
Remember to also install PhantomJS with the command
`webshot::install_phantomjs()` to be able to take screenshots from a
Leaflet map with the `mapview` package.
